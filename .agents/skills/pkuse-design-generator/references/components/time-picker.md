...
- 分组：数据录入
- 组件文档：<https://ant.design/components/time-picker-cn.md>
- 语义文档：<https://ant.design/components/time-picker-cn/semantic.md>
- 全文快照：`../antd/llms-full-cn.txt` 中的 `## time-picker-cn`
- 语义快照：`../antd/llms-semantic-cn.md` 中的 `time-picker-cn`
